...
public class Patient {
   ...
   private int rating, roomTimer, patientNumber;  //Severity rating, Amount of time patient will spend in a room, number of patient
   ...
   Patient() {
      ...
      totalPatientNum++;
      waitTime.start();
      patientNumber = totalPatientNum;
   }

   /**
    * Constructor for creating empty patients
    * @param createNew  Unused boolean the gives constructor a different address
    */
   Patient(boolean createNew) {
      this.rating = 0;
      this.roomTimer = 0;
      roomTime.start();
      patientNumber = 0;
   ...
   /**
    * Returns the priority based off wait time
    * @return  Priority
    */
   ...
   /**
    * Returns the number of the patient based on when it was created
